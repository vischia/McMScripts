...
class Request:
    ...
    def setJobID(self,x):
        self.JobID_ = x
        self.useJobID_ = True
    def setJobIDxsec(self,x):
        self.JobIDxsec_ = x
        self.useJobIDxsec_ = True
    def setNotes(self, x):
        self.Notes_ = x
        self.useNotes_ = True
    ...
    def getJobID(self):
        return self.JobID_
    def getJobIDxsec(self):
        return self.JobIDxsec_
    def getNotes(self):
        return self.Notes_
    ...
    def useJobIDxsec(self):
        return self.useJobIDxsec_
    def useNotes(self):
